...
import { getChampionshipById, getTeamById, getMatchesByChampionship, getVenueById } from "@/lib/mock-data"
...
export default function FixturePage({ params }: FixturePageProps) {
  ...
  const teamIds = Array.from(new Set(matches.flatMap((m) => [m.homeTeamId, m.awayTeamId]).filter(Boolean) as string[]))
              ...
              <div key={round}>
                ...
                <div className="grid gap-3">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-3 flex-1">
                                  ...
                                  <div className="min-w-0">
                                    ...
                                    <p className="text-xs text-muted-foreground">{homeTeam?.club}</p>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3 flex-1 justify-end text-right">
                                  <div className="min-w-0">
                                    ...
                                    <p className="text-xs text-muted-foreground">{awayTeam?.club}</p>
                                  </div>
                                  <div
                                    className="h-10 w-10 rounded-full flex items-center justify-center text-white font-bold text-sm"
                              ...
                              <div className="flex-1 space-y-1 text-sm">
                                ...
                                {match.scheduledTime && (
                                  <div className="flex items-center gap-2 text-muted-foreground">
                                    ...
                                    <span>{match.scheduledTime} hs</span>
                                  </div>
                                )}
                                {venue && (
                                  <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  {(() => {
                    ...
                    const byeTeam = getTeamById(byeTeamId)
                    return (
